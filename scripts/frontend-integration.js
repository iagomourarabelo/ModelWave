 ...
 * This file demonstrates how to integrate Modelwave with a web frontend
 */

// For React/Vue/Angular applications
export class ModelwaveClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ModelwaveClient(provider, contractAddress);
